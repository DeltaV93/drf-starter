...
const ConfirmNewPasswordPage = lazy(() => import('./components/pages/ConfirmNewPasswordPage.tsx'));
const SubscriptionPage = lazy(() => import('./components/pages/SubscriptionPage.tsx'));
